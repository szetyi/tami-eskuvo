    ...
    $("#dekoracio-button").click(function(e){
        ...
        if( $("#dekoracio-gallery").first().is(":hidden") 
            ...
            if(currently_open_gallery == 2) {
                $("#grafika-gallery .gallery .gallery-left").animate({"opacity" : 0}, 99);
                $("#grafika-gallery .gallery .gallery-right").animate({"opacity" : 0}, 99);
                $("#grafika-gallery").slideUp("slow", function(){
                    $("#dekoracio-gallery").slideDown("slow", function(){
                        $("#dekoracio-gallery .gallery .gallery-left").animate({"opacity" : 1}, 99);
                        $("#dekoracio-gallery .gallery .gallery-right").animate({"opacity" : 1}, 99);
                    });
                });
        ...
        // Egyébként csukjuk be
            ...
            $("#dekoracio-gallery .gallery .gallery-left").animate({"opacity" : 0}, 99);
            $("#dekoracio-gallery .gallery .gallery-right").animate({"opacity" : 0}, 99);
            ...
            if(currently_open_gallery == 1) {
                ...
                $("#dekoracio-gallery").slideUp("slow", function(){
                    $("#grafika-gallery").slideDown("slow", function(){
                        $("#grafika-gallery .gallery .gallery-left").animate({"opacity" : 1}, 99);
                        $("#grafika-gallery .gallery .gallery-right").animate({"opacity" : 1}, 99);
                    });
                });
            // Egyébként csak kinyitjuk
            } else {
